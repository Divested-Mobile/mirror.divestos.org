...
echo "Sony Xperia XZ3" > akatsuki/friendlyName;
...
echo "Xiaomi Mi 8" > dipper/friendlyName;
echo "Xiaomi Mi 8 Pro" > equuleus/friendlyName;
...
echo -e "Fastboot (Xiaomi)\nWill Brick\n2.0" > dipper/bootloader_information;
echo -e "Fastboot (Xiaomi)\nWill Brick\n2.0" > equuleus/bootloader_information;
echo -e "Fastboot (Xiaomi)\nWill Brick\n2.0" > polaris/bootloader_information;
echo -e "Fastboot (Xiaomi)\nWill Brick\n2.0" > ursa/bootloader_information;
...
echo "OnePlus 9R" > lemonades/friendlyName;
...
echo 4 > h830/status-20.0;
echo 4 > h850/status-20.0;
echo 4 > rs988/status-20.0;
...
echo 8 > d2spr/status-14.1;
echo 7 > d2tmo/status-14.1;
echo 8 > d2vzw/status-14.1;
...
echo "Sony Xperia 10" > kirin/friendlyName;
echo "Sony Xperia 10 Plus" > mermaid/friendlyName;
echo 1 > pioneer/status-19.1;
echo 8 > voyager/status-19.1;
echo 8 > discovery/status-19.1;
echo 7 > kirin/status-19.1;
echo 8 > mermaid/status-19.1;
echo 1 > pioneer/status-20.0;
echo 4 > voyager/status-20.0;
echo 4 > discovery/status-20.0;
echo 4 > kirin/status-20.0;
echo 5 > mermaid/status-20.0;
